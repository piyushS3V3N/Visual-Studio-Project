...
Partial Public Class ProductDataSet
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddTable1Row(ByVal P_Name As String, ByVal Price As Integer) As Table1Row
            Dim rowTable1Row As Table1Row = CType(Me.NewRow,Table1Row)
            Dim columnValuesArray() As Object = New Object() {Nothing, P_Name, Price}
...
Namespace ProductDataSetTableAdapters
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`P_Name`, `Price`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `P_Name` = ?, `Price` = ? WHERE ((`P_ID` = ?) AND ((? = 1 AND"& _ 
                " `P_Name` IS NULL) OR (`P_Name` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Pric"& _ 
                "e` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Datalistview.My.MySettings.Default.ProductConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT P_ID, P_Name, Price FROM Table1"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As ProductDataSet.Table1DataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As ProductDataSet.Table1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As ProductDataSet.Table1DataTable = New ProductDataSet.Table1DataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As ProductDataSet.Table1DataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_P_ID As Integer, ByVal Original_P_Name As String, ByVal Original_Price As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal P_Name As String, ByVal Price As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal P_Name As String, ByVal Price As Global.System.Nullable(Of Integer), ByVal Original_P_ID As Integer, ByVal Original_P_Name As String, ByVal Original_Price As Global.System.Nullable(Of Integer)) As Integer
            If (P_Name Is Nothing) Then
